...
def main(args):
    ...
    ####################################################################################################################
    bulk_tasks, sc_tasks = utils.cellline_dim(cell=args.cell)
    dim_model_out = 2

    for path in [args.sc_all + args.cell, args.result + '/' + args.method]:
    ...
    # target model path
    sc_all_path = args.sc_all + args.cell + para
    result_path = args.result + args.cell
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('--cell', type=str, default='PCa',
                        help='choose cell lines,Can be MCF7,OSCC,PC9,PCa.')
